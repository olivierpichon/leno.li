...
export const listFolder = ({album_id}, {access_token}) => (dispatch) => {
  ...
  return axios.get(`/files?q='${folder}'+in+parents&fields=files(id, name, mimeType, thumbnailLink, webContentLink, imageMediaMetadata)&pageSize=1000`, { params: { access_token }})
    .then((response) => {
